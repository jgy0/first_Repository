...
n2=r'D:\xinjianqq\赛题a：教育平台的线上课程智能推荐策略\login.csv'
path=r'D:\xinjianqq\赛题a：教育平台的线上课程智能推荐策略\project\task1_1__2.csv'
path1=r'D:\xinjianqq\赛题a：教育平台的线上课程智能推荐策略\project\task1_1_3____.csv'
path2=r'D:\xinjianqq\赛题a：教育平台的线上课程智能推荐策略\project\task1_1_4.csv'
...
def main():                  #程序入口
    ...
    data2_3=rm_same(data2_2)
    save(data2_3, path1)

    data_4=pd.read_csv(n2,encoding='gbk')
    data_4_1=rm_same(data_4)
    save(data_4_1, path2)

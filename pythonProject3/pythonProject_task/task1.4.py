...
source = pd.read_csv(r'D:\xinjianqq\2019赛题\A题\task1_1.csv',encoding='gbk',usecols=[7,11,14]) #读取销售日期、商品类型、销售金额列的数据
...
sale.to_csv(r'D:\xinjianqq\2019赛题\A题\task1_4.csv',encoding='gbk')

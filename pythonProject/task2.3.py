...
source = pd.read_csv(r'D:\xinjianqq\2019赛题\A题\task1_1.csv',encoding='gbk',usecols=[7,14,16]) #读取销售日期、是否促销、销售金额列的数据
...
plt.savefig(r'D:\xinjianqq\2019赛题\A题\result\task2_3.png')
plt.show()